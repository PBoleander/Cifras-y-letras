...
class GeneradorValorLetra {

    private static final char[] CONSONANTES_CASTELLANO = "BCDFGHJKLMNÑPQRSTVWXYZ".toCharArray();
    private static final char[] CONSONANTES_CATALAN = "BCÇDFGHJKLMNPQRSTVWXYZ".toCharArray();
    private static final char[] CONSONANTES_INGLES = "BCDFGHJKLMNPQRSTVWXYZ".toCharArray();
    private static final char[] VOCALES = "AEIOU".toCharArray();

    private static final int[] FRECUENCIAS_CONSONANTES_CASTELLANO =
    ...
    private static final int[] FRECUENCIAS_VOCALES_CASTELLANO = {64706, 102291, 132533, 175146, 190023};

    private static final int[] FRECUENCIAS_CONSONANTES_CATALAN =
    ...
    private static final int[] FRECUENCIAS_VOCALES_CATALAN = {119113, 226839, 302472, 353159, 395728};

    private static final int[] FRECUENCIAS_CONSONANTES_INGLES =
    ...
    private static final int[] FRECUENCIAS_VOCALES_INGLES = {27851, 73677, 103057, 125249, 138467};
